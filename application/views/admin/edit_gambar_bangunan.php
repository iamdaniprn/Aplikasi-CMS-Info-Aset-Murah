                    ...
                    <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3 class="panel-title">Edit Gambar Agunan</h3></div>
                                <div class="panel-body">
                                    <?php echo $this->session->flashdata('sukses'); ?>
                                    <form class="form-horizontal" action="<?php echo site_url('admin/update_gambar_bangunan');?>" method="post" enctype="multipart/form-data">
