                ...
                <div class="content">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <a href="<?php echo site_url('admin/properti_terjual');?>"><button class="btn btn-danger">Kembali</button></a>
                                <a href="<?php echo site_url('laporan/cetak_properti_lelang_terjual_verifikator');?>"><button class="btn btn-success">Cetak</button></a><br><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Data Properti Lelang Terjual (verifikator)</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php $no=0; foreach ($properti_lelang_verifikator_terjual as $row): 
                                                        $no++;
                                                        $status = $row->status;
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                             ...
                                                             <td>
                                                                <a href="<?php echo site_url('admin/detail_agunan_lelang/'.$row->id);?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach;?>
                                                    </tbody>
