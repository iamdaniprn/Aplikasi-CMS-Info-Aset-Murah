                    ...
                    <div class="container">
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3 class="panel-title">Edit Status Gambar Akses Jalan</h3></div>
                                <div class="panel-body">
                                    <?php echo $this->session->flashdata('sukses'); ?>
                                    <form class="form-horizontal" action="<?php echo site_url('admin/update_status_foto_akses');?>" method="post" enctype="multipart/form-data">
                                    <?php foreach ($data_id_gambar_akses as $row): 
                                    ?>
                                        <input type="hidden" name="id_foto_akses" value="<?php echo $row['id_foto_akses'];?>">
                                    
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="pwd">ID Gambar Agunan:</label>
                                        <div class="col-sm-9"> 
                                          <input type="text" class="form-control" value="<?php echo $row['id_foto_akses'];?>" readonly>
                                        </div>
                                      </div>
