                    ...
                    <div class="container">
							<div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Status Properti</h3></div>
                                    <div class="panel-body">
										<?php echo form_open_multipart('admin/update_status_properti',['class'=>'form-horizontal','role'=>'form']);?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <select name="status_properti" class="form-control" >
