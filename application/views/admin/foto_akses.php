                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Foto Akses Jalan</h3>
                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if($row['foto'] == ''){
                                                                    ...
                                                                    ?> <img src="data:image/jpeg;base64,<?php echo $row['foto'] ?>" style="height: 150px; width: 200px;" alt="" class="img-fluid"> <?php
                                                                }
                                                                ?>
                                                            ...
                                                            <td><a href="<?php echo site_url('admin/edit_status_foto_akses/'.$row['id_foto_akses']);?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a> 
                                                            </td>
                                                            <td><a href="<?php echo site_url('admin/edit_gambar_akses/'.$row['id_foto_akses']);?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a> 
                                                            </td>
                                                        </tr>
                                                    <?php endforeach;?>
                                                    </tbody>
