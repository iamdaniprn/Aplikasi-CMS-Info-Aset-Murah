                ...
                <div class="content">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <a href="<?php echo site_url('laporan/cetak_properti_lelang_unggulan');?>"><button class="btn btn-success">Cetak</button></a><br><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Data Properti Lelang Unggulan (Operator)</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php $no = 0; foreach ($properti_lelang_unggulan as $row): 
                                                        $no++;
                                                        $status = $row->status;
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form class="form-horizontal" action="<?php echo site_url('admin/set_lelang_biasa_operator');?>" method="post">
                                                                <input type="hidden" name="id" value="<?php echo $row->id ?>">
                                                                <input type="hidden" name="kategori" value="0">
                                                                <button type="submit" class="btn btn-primary btn-sm">Set Biasa</button>
                                                                </form>
                                                            </td>
                                                            <td>
                                                                <?php 
                                                            ...
                                                            <td><a href="<?php echo site_url('admin/edit_properti_lelang_unggulan_operator/'.$row->id);?>" class="btn btn-info btn-sm" title="EDIT"><i class="fa fa-pencil"></i></a> 
                                                                <a href="<?php echo site_url('admin/detail_agunan/'.$row->id);?>" class="btn btn-success btn-sm" title="LIHAT"><i class="fa fa-eye"></i></a>
                                                                <a href="<?php echo site_url('admin/hapus_properti_unggulan/'.$row->id);?>" class="btn btn-danger btn-sm" title="HAPUS"><i class="fa fa-close"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach;?>
                                                    </tbody>
