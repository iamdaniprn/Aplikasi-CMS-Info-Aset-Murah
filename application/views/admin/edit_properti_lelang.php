                    ...
                    <div class="container">
							<div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit Properti</h3></div>
                                    <div class="panel-body">
										<?php echo form_open_multipart('admin/update_properti_lelang',['class'=>'form-horizontal','role'=>'form']);?>
