                ...
                <div class="content">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <a href="<?php echo site_url('laporan/cetak_data_properti_lelang_terjual');?>"><button class="btn btn-success">Cetak</button></a><br><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Data Properti Lelang Terjual</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php $no=0; foreach ($data_agunan_lelang_terjual as $row): 
                                                        $no++;
                                                        $status = $row->status;
                                                        ?>
                                                        <tr>
