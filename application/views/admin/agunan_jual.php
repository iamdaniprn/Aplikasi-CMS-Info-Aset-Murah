                ...
                <div class="content">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <a href="<?php echo site_url('laporan/cetak_data_properti_jual');?>"><button class="btn btn-success">Cetak</button></a><br><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Data Properti Jual</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php $no = 0; foreach ($agunan_jual as $row): 
                                                        $no++;
                                                        $status   = $row->status;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form class="form-horizontal" action="<?php echo site_url('admin/set_unggulan');?>" method="post">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo site_url('admin/edit_properti_jual/'.$row->id);?>" class="btn btn-info btn-sm" title="EDIT"><i class="fa fa-pencil"></i></a>&nbsp;
                                                                <a href="<?php echo site_url('admin/detail_agunan/'.$row->id);?>" class="btn btn-success btn-sm" title="LIHAT"><i class="fa fa-eye"></i></a>&nbsp;
                                                                <a href="<?php echo site_url('admin/hapus_properti/'.$row->id);?>" class="btn btn-danger btn-sm" title="HAPUS"><i class="fa fa-close"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach;?>
                                                    </tbody>
