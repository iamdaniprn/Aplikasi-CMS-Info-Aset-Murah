                ...
                <div class="content">
                    ...
                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <a href="<?php echo site_url('laporan/cetak_data_properti_jual_unggulan');?>"><button class="btn btn-success">Cetak</button></a><br><br>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Data Properti Jual Unggulan</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    <?php $no = 0; foreach ($agunan_unggulan as $row): 
                                                        $no++;
                                                        $status = $row->status;
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form class="form-horizontal" action="<?php echo site_url('admin/set_biasa');?>" method="post">
                                                            ...
                                                            <td><a href="<?php echo site_url('admin/edit_properti_jual_unggulan/'.$row->id);?>" class="btn btn-info btn-sm" title="EDIT"><i class="fa fa-pencil"></i></a> 
