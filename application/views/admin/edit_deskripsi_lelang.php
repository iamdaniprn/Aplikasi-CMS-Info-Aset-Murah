                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" action="<?php echo site_url('admin/update_deskripsi_lelang');?>" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-9"> 
                                            <input type="text" class="form-control uang" name="nama_pegawai" value="<?php echo $row['nama_pegawai'];?>" readonly>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-9"> 
                                            <input type="text" class="form-control uang" name="no_telepon" value="<?php echo $row['phone'];?>" readonly>
                                          </div>
                                        </div>
