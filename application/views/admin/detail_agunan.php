                                            ...
                                            { ?>
                                              ...
                                              <div class="row portfolio-project">
                                                ...
                                                <hr size="12px">
                                                  ...
                                                  <div class="row">
                                                   ...
                                                   <div class="col-md-8 col-xs-12">
                                                      ...
                                                      <table class="table-condensed">
                                                          ...
                                                          <td><p>:</p></td>
                                                          <td><p><?php echo $row['verifikator']; ?> </p></td>
                                                          </tr>

                                                          <tr>
                                                          <td><h5>No Telepon</h5></td>
                                                          <td><p>:</p></td>
                                                          <td><p><?php echo $row['no_telepon']; ?> </p></td>
                                                          </tr>
                                                  ...
                                                  <div class="col-md-12">
                                                      <a href="<?php echo site_url('admin/edit_deskripsi/'.$row['id_agunan']);?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit Deskripsi
                                                      </a> 
                                                      <a href="<?php echo site_url('laporan/cetak_deskripsi/'.$row['id_agunan']);?>" class="btn btn-success btn-sm" target="_BLANK"><i class="fa fa-print"></i> Cetak Brosur 1
                                                      </a> 
                                                      <a href="<?php echo site_url('laporan/cetak_brosur/'.$row['id_agunan']);?>" class="btn btn-warning btn-sm" target="_BLANK"><i class="fa fa-print"></i> Cetak Brosur 2
                                                      </a> 
                                                  </div>
