                    ...
                    <div class="container">
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3 class="panel-title">Tambah Gambar Properti</h3></div>
                                <div class="panel-body">
                                    <form class="form-horizontal" action="<?php echo site_url('admin/simpan_gambar_agunan');?>" method="post" enctype="multipart/form-data">
